class Modalize{
    constructor(){
        ...
        this.topstyle2.transition = "visibility 0s, opacity 0.5s linear";
        /* Inner Style */
        ...
        this.closeButton.addEventListener('click', ()=>{this.topDiv.className = "topModal"; });
